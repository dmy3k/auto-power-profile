...
export class UpowerDbus {
  ...
  getPowerState() {
    ...
    return {
      ...
      // AC adapter is physically connected (Online=true) but battery is still
      // draining — indicates an underpowered adapter that cannot sustain system load
      acConnectedButDischarging: acOnline === true && batteryDischarging
    };
  }
