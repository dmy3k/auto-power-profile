  ...
  getPowerState() {
    ...
    return {
      ...
      weakAdapterSuspected:
        acOnline === true && batteryDischarging && energyRate > 0,
      chargingThresholdReached:
        batteryState === UPower.DeviceState.PENDING_CHARGE ||
        batteryState === UPower.DeviceState.FULLY_CHARGED
    };
  }
